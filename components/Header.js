    ...
    <header className="sticky top-0 bg-white">
      <div className='flex w-full p-6 items-center'>
        ...
        <form className="flex flex-grow px-6 py-3 ml-10 mr-5 border-gray-200 rounded-full shadow-lg max-w-3xl items-center">
          ...
          <SearchIcon className="h-6 text-blue-400 hidden sm:inline-flex" />
          <button hidden type="submit" onClick={search}>
            Search
          </button>
        </form>
        <Avatar className='ml-auto'
            url='https://yt3.ggpht.com/yti/APfAmoFV_G4Ix1hgko-tLXkyZdCGH-f9sqMWyOkedxOo=s88-c-k-c0x00ffffff-no-rj-mo'
        />
      </div>
